...
import { Loader2, CreditCard, Check, Upload, Clock, Badge, Radio } from "lucide-react"
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid gap-4 py-4">
              ...
              <div className="grid gap-2">
                ...
                <Select value={brandCategory} onValueChange={setBrandCategory} required>
                  <SelectTrigger className="bg-white border-[#e0e0e0] text-[#333333]">
                ...
                <div className="flex gap-3">
                  {[10, 20, 30].map((d) => (
                    <button
                      key={d}
                      type="button"
                      onClick={() => setDuration(d as 10 | 20 | 30)}
                ...
                <div className="grid gap-2">
                  ...
                  <div className="relative border-2 border-dashed border-[#e0e0e0] rounded-md p-6 flex flex-col items-center justify-center bg-white">
                    ...
                    <p className="text-sm text-[#666666] text-center">
                      Click to upload or drag and drop your audio file (MP3, max {duration} seconds)
                    </p>
                    {audioFile && (
            ...
            <DialogFooter className="flex items-center justify-between">
              ...
              {companyName && selectedShow && brandCategory && (adType === "audio" && audioFile || adType === "script" && adScript) ? (
                <OnchainCheckout
                    ...
                    try {
                      const response = await fetch("/api/advertising", {
                        ...
                        body: JSON.stringify({
                          ...
                          duration,
                          brandCategory,
                          audioUrl: adType === "audio" && audioFile ? URL.createObjectURL(audioFile) : undefined,
                          amount: packageType === "branded" ? 100 : 50,
                        }),
                      })
