...
import { Mic, Music, MessageSquare, Send, Clock, Users, Heart, Megaphone } from "lucide-react"
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            className="bg-gradient-to-r from-[#ff5722] to-[#f4511e] hover:from-[#f4511e] hover:to-[#e64a19] text-white font-semibold"
          >
